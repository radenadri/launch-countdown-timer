...
export const TimerContainer = ({days, hours, minutes ,seconds }: timeProps) => {
  ...
  return (
    <div className="mt-2 md:mt-20 rounded-xl">
      <div className="grid grid-cols-2 gap-4 px-10 py-6 md:flex md:items-center md:justify-between md:mt-2 rounded-xl md:px-6 md:py-8">
        <NumberBox num={days } unit="Days" flip={daysFlip} />
        <span className="hidden -mt-8 text-5xl font-normal md:inline-block md:text-7xl text-gray-50">:</span>
